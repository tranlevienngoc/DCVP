...
const useModeTheme = () => {
  ...
  const darkModeColors = {
    ...
    border400: useColorModeValue('1px solid #2c2b38', '1px solid #1F2231'),
    ...
    text550: useColorModeValue('#b7becb', '#D4D4D6'),
    text555: useColorModeValue('#eff3fb', '#F6F7F9'),
    text600: useColorModeValue('white', 'white'),
    ...
    bg50: useColorModeValue('red', '#252A3F'),
    ...
    bg590: useColorModeValue('rgb(248, 249, 253)', '#292e42'),
    bg600: useColorModeValue('#17122b', '#171924'),
    bg650: useColorModeValue('#EFF0F2', '#252A3F'),
    bg655: useColorModeValue('#fafafa', '#0b0e11'),

    bg800: useColorModeValue('#F8F9FD', '#171924'),
    ...
    gridLineColor: useColorModeValue('#fcac', '#E2E8F0'),
    linearGradientChart: useColorModeValue('#fcac', '#000'),
  };
