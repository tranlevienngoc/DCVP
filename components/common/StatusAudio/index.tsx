...
function StatusSound() {
  ...
  return (
    // <Box className="sound" onClick={toggleMuteAudio}>
    //   {muteAudio ? (
    //     <Icon as={HiMiniSpeakerWave} color="#000" w={10} h={10} />
    //   ) : (
    //     <Icon as={HiMiniSpeakerXMark} color="#000" w={10} h={10} />
    //   )}
    // </Box>
    <Box className="sound">
